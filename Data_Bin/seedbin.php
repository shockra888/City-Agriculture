    ...
    <div id="MyModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="GET" action="../php/recoverseed.php" id="restore-seed">
                    <input type="hidden" name="id">
                </form>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="submit" form="restore-seed" class="btn btn-danger">Restore</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function confirmRestore(self) {
            ...
            document.getElementById("restore-seed").id.value = id;
            $("#MyModal").modal("show");
