...
<head>
    ...
    <title>Distributed Fertilizer</title>
</head>
<body>
    <div class="wrapper">
        <!-- Sidebar Holder -->
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        <div class="col-sm-5">
                            <h4>Distributed | Fertilizers</h4>
                        </div>
                    </div>
                </div>
                    <div class="table-responsive">
                        <table id="fertdisttable" class="display dataTable">
...
$(document).ready(function(){
    ...
    $('#fertdisttable').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'../php/fertdisthistory.php'
        },
        dom: 'lBfrtip',
        buttons: [
            {
                extend: 'excel',
                title: 'Distributed Fertilizers',
        ...
        'columns': [
            ...
            { data: 'fertilizer_count',render : function(data,type,full){
                return  data + ' Pcs';
            }}
        ],
    });
