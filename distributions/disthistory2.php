...
<head>
    ...
    <title>Distributed Equipments</title>
</head>
<body>
    <div class="wrapper">
        <!-- Sidebar Holder -->
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        <div class="col-sm-5">
                            <h4>Distributed | Farming Equipments</h4>
                        </div>
                    </div>
                </div>
                    <div class="table-responsive">
                        <table id="utildisttable" class="display dataTable">
...
$(document).ready(function(){
    ...
    $('#utildisttable').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url':'../php/utildisthistory.php'
        },
        dom: 'lBfrtip',
        buttons: [
            {
                extend: 'excel',
                title: 'Distributed Farming Equipments',
        ...
        'columns': [
            ...
            { data: 'Barangay' },
            { data: 'utility_name' },
            { data: 'utility_count',render : function(data,type,full){
                return  data + ' Pcs';
            }}
        ],
    });
